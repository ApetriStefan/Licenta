...
application {
    mainModule.set("org.stefanapetri.licenta")
    mainClass.set("org.stefanapetri.licenta.MainApplication")

    // Add this line to fix the native access warnings
